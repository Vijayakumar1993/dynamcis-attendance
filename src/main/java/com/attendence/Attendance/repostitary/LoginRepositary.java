...
public interface LoginRepositary extends JpaRepository<Users, Long> {
    ...
    List<Users> findByCustomerId(Customer customerId);
    List<Users> findByUsernameAndCustomerId(String username, Customer customerId);
    int deleteByCustomerId(Customer customer);
}
